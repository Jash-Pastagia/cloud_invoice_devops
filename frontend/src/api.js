...
// API Base URLs - Updated with browser-safe port for payment service
const API_URLS = {
  auth: 'http://localhost:4000',
  invoice: 'http://localhost:5050',
  payment: 'http://localhost:6060', // Changed from 6000 to browser-safe port
  notification: 'http://localhost:7200', // Changed to avoid macOS Control Center conflict
  analytics: 'http://localhost:7100'
}
